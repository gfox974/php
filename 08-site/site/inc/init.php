...
define('RACINE_SITE','/php/08-site/site/'); # Va etre utilisé car on va faire une integration header <- index -> footer de façon séparée, il faut utiliser des paths en absolus via la constante, la structure de l'arbo n'ayant pas a changer
